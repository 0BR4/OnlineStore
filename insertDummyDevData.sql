...
DELETE FROM online_order_quantities;
...
INSERT INTO online_order (address_id, user_id) VALUES (@address1, @userId1);
INSERT INTO online_order (address_id, user_id) VALUES (@address1, @userId1);
INSERT INTO online_order (address_id, user_id) VALUES (@address1, @userId1);
INSERT INTO online_order (address_id, user_id) VALUES (@address2, @userId2);
INSERT INTO online_order (address_id, user_id) VALUES (@address2, @userId2);

DECLARE @order1 INT, @order2 INT, @order3 INT, @order4 INT, @order5 INT;

SELECT TOP 1 @order1 = id FROM online_order WHERE address_id = @address1 AND user_id = @userId1 ORDER BY id DESC
SELECT @order2 = id FROM online_order WHERE address_id = @address1 AND user_id = @userId1 ORDER BY id DESC OFFSET 1 ROW FETCH FIRST 1 ROW ONLY
SELECT  @order3 = id FROM online_order WHERE address_id = @address1 AND user_id = @userId1 ORDER BY id DESC OFFSET 2 ROW FETCH FIRST 1 ROW ONLY
SELECT TOP 1 @order4 = id FROM online_order WHERE address_id = @address2 AND user_id = @userId2 ORDER BY id DESC
SELECT @order5 = id FROM online_order WHERE address_id = @address2 AND user_id = @userId2 ORDER BY id DESC OFFSET 1 ROW FETCH FIRST 1 ROW ONLY

    INSERT INTO online_order_quantities (order_id, product_id, quantity) VALUES (@order1, @product1, 5);
INSERT INTO online_order_quantities (order_id, product_id, quantity) VALUES (@order1, @product2, 5);
INSERT INTO online_order_quantities (order_id, product_id, quantity) VALUES (@order2, @product3, 5);
INSERT INTO online_order_quantities (order_id, product_id, quantity) VALUES (@order2, @product2, 5);
INSERT INTO online_order_quantities (order_id, product_id, quantity) VALUES (@order2, @product5, 5);
INSERT INTO online_order_quantities (order_id, product_id, quantity) VALUES (@order4, @product4, 5);
INSERT INTO online_order_quantities (order_id, product_id, quantity) VALUES (@order4, @product2, 5);
INSERT INTO online_order_quantities (order_id, product_id, quantity) VALUES (@order3, @product3, 5);
INSERT INTO online_order_quantities (order_id, product_id, quantity) VALUES (@order5, @product3, 5);
INSERT INTO online_order_quantities (order_id, product_id, quantity) VALUES (@order5, @product1, 5);